    ...
    >
      {Array.from({ length: segmentCount }, (_, index) => {
        ...
        return (
          <span
            key={index}
            className={`h-2 w-[3px] shrink-0 transition-colors duration-200 ${
              isActive
              ...
              {(["en", "zh", "ja"] as const).map((l) => {
                ...
                return (
                  <button
                    key={l}
                    onClick={() => setLang(l)}
                    className={`relative py-2 text-[11px] tracking-[0.14em] font-medium uppercase transition-colors duration-1000 ${
                      langActive
                        ? "text-neutral-950 dark:text-neutral-100"
                ...
                {(["en", "zh", "ja"] as const).map((l) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative py-2 font-mono text-[11px] tracking-[0.14em] font-medium uppercase transition-colors duration-300 ${
                        langActive
                          ? "text-neutral-950 dark:text-neutral-100"
                         : "text-neutral-800 hover:text-neutral-950 dark:text-neutral-400 dark:hover:text-neutral-100"
                      }`}
