...
export const SERIES_TRANSLATIONS: Record<Exclude<Language, "en">, Record<string, SeriesTranslation>> = {
  zh: {
    ...
    "whispers-in-silver-light": {
      title: "银色晨光中的低语",
      subtitle: "私密肖像",
      description: "一组由柔和光线、细腻质感与稍纵即逝的沉思时刻塑造的安静肖像。作品探索孤独、优雅，以及人物、花朵与空间之间温柔的对话。",
      coverTitle: "静静阅读的人",
      coverCaption: "身影坐在古董椅上静静捧书，置身于私密房间温暖的氛围之中。",
      location: "日本",
      category: "人像",
      images: {
        "02": { title: "落花", caption: "低垂的目光与指间轻捻的一片花瓣，捕捉到一个温柔的沉思瞬间。" },
        "03": { title: "光中的花", caption: "花朵的影子落在肩头，让身体的柔软与自然光的诗意彼此交融。" },
        "04": { title: "她身后的玫瑰", caption: "从背后望去，身影成为花朵影子的安静画布，悬置在温暖的午后光线中。" },
        "05": { title: "触碰花意", caption: "花朵、手与转瞬即逝的动作构成一幅近距离研究，强调质感、亲密与温柔的好奇。" },
        "06": { title: "穿过光线", caption: "流动的裙摆与明亮的窗户共同构成一幅关于移动、优雅与静默离开的梦幻肖像。" }
      }
    },
    "skyline-frequency": {
      title: "天际线频率",
      subtitle: "都市肖像",
      description: "一组融合广角视角、复古科技与明亮日光的俏皮都市肖像。人物与镜头互动，周围的摩天大楼放大了能量、自由与现代城市生活的感觉。",
      coverTitle: "伸手可及的信号",
      coverCaption: "翻盖手机与伸出的手，在人物、相机与城市之间建立起直接的联系。",
      location: "日本东京",
      category: "人像",
      images: {
        "02": { title: "口袋里的视角", caption: "便携相机与俏皮手势，捕捉都市自我表达的即兴气息。" },
        "03": { title: "城市之声", caption: "耳机成为个人节奏的象征，置于天际线下的戏剧性低角度肖像之中。" },
        "04": { title: "触碰天空", caption: "伸出的手、明亮的表情与高耸的建筑，为画面带来运动感与年轻的自信。" },
        "05": { title: "突破画框", caption: "双手伸出传统肖像的边界，让照片变成一次充满能量的互动。" },
        "06": { title: "塔楼之间", caption: "沉静而自信的姿态，与鲜明的建筑线条和开阔的蓝天形成平衡。" }
      }
    },
    "whispers-in-green": {
      title: "绿意中的低语",
      subtitle: "植物肖像",
      description: "一组由柔和光线、细腻叶片与亲密表情构成的安静肖像作品。每一张照片都在探索摄影者与自然之间轻柔的联系。",
      coverTitle: "光影中的一片叶",
      coverCaption: "一幅柔和的肖像，让脆弱的叶片成为含蓄温柔情感的细节。",
      location: "日本",
      category: "人像",
      images: {
        "02": { title: "藤蔓之间", caption: "悬挂的绿叶包围着人物，捕捉一瞬平静而专注的目光。" },
        "03": { title: "花园遐想", caption: "被层叠的叶片环绕，人物停留在安宁而梦幻的片刻。" },
        "04": { title: "斑驳的目光", caption: "透过叶影的阳光与模糊的绿意，构成一幅层次丰富的肖像。" },
        "05": { title: "安静的花", caption: "沉思的表情与细小的藤蔓共同传达出静止与温柔的情绪。" },
        "06": { title: "穿过绿色", caption: "前景中的柔和叶影包围着直接的目光，让亲密与自然的宁静相互交叠。" }
      }
    }
  },
  ja: {
    ...
    "whispers-in-silver-light": {
      title: "銀色の光の中のささやき",
      subtitle: "親密なポートレート",
      description: "やわらかな光、繊細な質感、そして一瞬の思索から生まれた静かなポートレート・シリーズ。人物と花、空間のあいだにある孤独と優雅さ、穏やかな対話を探求する。",
      coverTitle: "静かな読書",
      coverCaption: "アンティークの椅子に腰掛け、本を静かに手にする姿。私的な部屋のあたたかな空気に包まれている。",
      location: "日本",
      category: "ポートレート",
      images: {
        "02": { title: "落ちた花びら", caption: "伏せたまなざしと指先に挟まれた一枚の花びらが、やさしい思索の瞬間を捉える。" },
        "03": { title: "光の中の花", caption: "花の影が肩に落ち、身体のやわらかさと自然光の詩情が溶け合う。" },
        "04": { title: "彼女の背後のバラ", caption: "後ろ姿の人物が花の影を受ける静かなキャンバスとなり、あたたかな午後の光に浮かぶ。" },
        "05": { title: "花に触れる", caption: "花と手、そして束の間の仕草を見つめるクローズアップ。質感と親密さ、やさしい好奇心を描く。" },
        "06": { title: "光を通り抜けて", caption: "流れるドレスと明るい窓が、動きと優雅さ、静かな旅立ちを夢のような肖像にする。" }
      }
    },
    "skyline-frequency": {
      title: "スカイライン・フリークエンシー",
      subtitle: "アーバン・ポートレート",
      description: "広角の視点、レトロなテクノロジー、明るい昼光を組み合わせた、遊び心のある都市ポートレート。被写体とレンズのやり取りを、周囲の高層ビルがエネルギーと自由、現代の都市生活の感覚へと広げていく。",
      coverTitle: "手の届くシグナル",
      coverCaption: "折りたたみ式携帯電話と伸ばされた手が、人物とカメラ、そして都市のあいだに直接的なつながりをつくる。",
      location: "日本、東京",
      category: "ポートレート",
      images: {
        "02": { title: "ポケットの視点", caption: "コンパクトカメラと遊び心のある仕草が、都市での自然な自己表現を捉える。" },
        "03": { title: "都市の音", caption: "ヘッドホンが個人のリズムの象徴となる、スカイラインを背景にしたドラマチックなローアングル。" },
        "04": { title: "空に触れる", caption: "伸ばされた手、明るい表情、高層ビルが、動きと若々しい自信をフレームにもたらす。" },
        "05": { title: "フレームを越えて", caption: "両手が伝統的なポートレートの空間を越え、写真をエネルギッシュな対話へと変える。" },
        "06": { title: "塔のあいだ", caption: "落ち着きと自信のある姿が、強い建築線と広がる青空のバランスをとる。" }
      }
    },
    "whispers-in-green": {
      title: "緑の中の囁き",
      subtitle: "ボタニカル・ポートレート",
      description: "柔らかな光、繊細な葉、そして親密な表情から生まれた静かなポートレートシリーズ。被写体と自然のあいだにある穏やかなつながりを写し取ります。",
      coverTitle: "光の中の一葉",
      coverCaption: "かすかな葉が、やさしさを湛えた静かなポートレートの一部になる。",
      location: "日本",
      category: "ポートレート",
      images: {
        "02": { title: "蔓のあいだ", caption: "垂れ下がる緑に包まれた、穏やかで静かな視線。" },
        "03": { title: "庭の夢想", caption: "重なる葉に囲まれ、夢のような静けさの中で立ち止まる。" },
        "04": { title: "木漏れ日の視線", caption: "濾された光とぼけた葉が、静かな強さを持つ肖像をつくる。" },
        "05": { title: "静かな花", caption: "思索する表情と細い蔓が、静けさとやわらかな感情を伝える。" },
        "06": { title: "緑を通して", caption: "前景の葉越しに向けられた視線が、親密さと自然の静けさを重ねる。" }
      }
    }
  }
};
